package framework.selenium.app2;
...
public class ExecuteFeature2Test {

	private static Logger classLogger = LogManager.getLogger(ExecuteFeature2Test.class.getName());
